...
The compiler writes two PRAB LaTeX tables:
    ...
    1. A detailed table of metric entries inside configurable ell and
       R_total zoom limits.
    2. Means and sample standard deviations of ell and R_total for
...
def build_summary_statistics_table(
    ...
    *,
    ...
    caption = (
        r"Means and sample standard deviations of $\ell$ and "
        r"$R_{\mathrm{total}}$ for all analysed metric entries satisfying "
        r"the configured mixed-field thresholds. Homotypic crossings "
