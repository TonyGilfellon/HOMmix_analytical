...
def write_method_comparison_appendix(
    *,
    ...
    Fourth table:
        heterotypic Fourier/RF-multipole values vs heterotypic Hessian/Taylor values.
    ...
    tables = [
        ...
        latex_multipole_hessian_table(
            label="tab:rf_multipole_hessian_benchmark",
            caption=(
                r"Benchmark comparison of the heterotypic Fourier/RF-multipole "
                r"workflow against the heterotypic Hessian/Taylor-fit workflow. "
                r"Only the relevant family metric is listed: $k_{\parallel}$ for "
                r"monopole modes, $k_{\perp}$ for dipole modes, and $K_Q$ for "
                r"quadrupole modes."
            ),
            rows_by_metric={
                "k_parallel": mh_kpar_rows_for_table,
                "k_perp": mh_kperp_rows_for_table,
                "K_Q": mh_KQ_rows_for_table,
            },
        ),
    ]
