...
def fmt_sci(value: object, significant_figures: int = 3) -> str:
...
def fmt_float(value: object, decimal_places: int = 3) -> str:
    value = finite_or_nan(value)
    if not math.isfinite(value):
        return "--"
...
def fmt_percentage(value: object, decimal_places: int = 2) -> str:
    value = finite_or_nan(value)
    if not math.isfinite(value):
        return "--"
