...
def heterotypic_table(
    ...
    *,
    ...
    return rf"""
\begin{{table*}}[htbp]
\caption{{Aggregated heterotypic {pair_name} Taylor/Hessian results. Only the uppercase, length-normalised metrics relevant to the two parent families are reported. {units_text}}}
