...
def _write_combined_rtotal_overall_and_zoom_log_plot(
    *,
    ...
    """Write the logarithmic zoom at left and full logarithmic plot at right."""

    # Left: zoom. Right: overall population.
    fig, (ax_zoom, ax_overall) = plt.subplots(
        1,
        2,
    ...
    ax_overall.text(
        ell_min + 0.02 * (ell_max - ell_min),
        rtotal_max * 1.08,
        "Zoom region",
        fontsize=RTOTAL_TWO_PANEL_ZOOM_LABEL_FONTSIZE,
        color=ZOOM_BOX_COLOUR,
        ha="left",
        va="bottom",
        zorder=4,
    ...
    # Connect the left-hand corners of the rectangle in the overall panel
    # to the right-hand bounds of the left zoom panel.
    for source_y, target_y in (
        (rtotal_min, rtotal_min),
        (rtotal_max, rtotal_max),
    ):
        connector = ConnectionPatch(
            xyA=(ell_min, source_y),
            coordsA=ax_overall.transData,
            xyB=(ell_max, target_y),
    ...
    # Use one enlarged legend in the right-hand overall panel.
    ...
    # The lower connector is deliberately beneath the opaque right-panel
    # legend because the connector has zorder=0 and the legend zorder=10.
    fig.subplots_adjust(
        left=0.085,
        right=0.985,
        bottom=0.16,
