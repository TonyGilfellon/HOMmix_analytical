...
# Bold publication colour scheme. The red reference lines are kept unchanged.
HOMOTYPIC_COLOUR    = "#00796B"   # deep teal
HETEROTYPIC_COLOUR  = "#6A3D9A"   # deep purple
...
def _write_annotated_combined_zoom_plot(
    *,
    ...
    ax.axhline(1.0, color=REFERENCE_COLOUR, linestyle="--", linewidth=1.2,
...
def _write_rtotal_histogram(
    *,
    ...
    ax.axvline(1.0, color=REFERENCE_COLOUR, linestyle="--", linewidth=1.2,
               label=r"$R_{\mathrm{total}}=1$")
    ax.grid(True, which="both", alpha=0.3)
    ax.legend(loc="best", frameon=True, framealpha=1.0,
