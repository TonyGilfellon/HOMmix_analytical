...
SCRIPT_VERSION = "2026-07-13-analysis-radius-v6-taylor-residuals"
...
def analyse_crossing_folder(
    ...
    *,
    ...
    for field_name, job in jobs.items():
        ...
        _, taylor_mask = analysis_circle_geometry(
            maps["x_m"], maps["y_m"], analysis_pixels=analysis_pixels
        )
        taylor_fit = fit_quadratic_taylor_inside_circle(
            maps["Vz"], maps["x_m"], maps["y_m"], taylor_mask
        )
