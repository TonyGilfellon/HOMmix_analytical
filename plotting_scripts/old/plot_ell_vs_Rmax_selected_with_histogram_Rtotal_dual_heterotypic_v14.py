...
# Fine line weights for markers, reference lines, boxes and histogram edges.
DEFAULT_MARKER_SIZE = 8.5
DEFAULT_MARKER_EDGE_WIDTH = 0.9
LARGE_MARKER_SIZE = 7.0
LARGE_MARKER_EDGE_WIDTH = 0.8
REFERENCE_LINE_WIDTH = 1.2
ZOOM_BOX_LINE_WIDTH = 0.9
HISTOGRAM_EDGE_WIDTH = 0.7
LEGEND_FRAME_WIDTH = 0.7
SPINE_LINE_WIDTH = 0.7

ZOOM_LARGE_MARKER_SIZE = 11.
ZOOM_LARGE_MARKER_EDGE_WIDTH = 1.0
...
def _apply_fine_plot_styling(ax: Any) -> None:
    ...
    ax.tick_params(width=SPINE_LINE_WIDTH)
...
def rmax_plot_point(
    ...
    *,
    ...
    parent_maximum = max(k1, k2)
    r_max = safe_ratio(mixed_maximum, parent_maximum)
...
def _write_annotated_combined_zoom_plot(
    *,
    ...
    homotypic_colour = HOMOTYPIC_COLOUR
    heterotypic_colour = HETEROTYPIC_COLOUR
    ...
    for results, metric_key, marker, base_label, color in groups:
        ...
        _plot_hollow_markers(
            ...
            color=color, markersize=12.0, markeredgewidth=2.2,
        )
    ...
    ax.axhline(1.0, color=REFERENCE_COLOUR, linestyle="--", linewidth=REFERENCE_LINE_WIDTH,
    ...
    *,
    ...
    for group_results, group_metric, marker, label_color in combined_groups:
        ...
        _plot_hollow_markers(
            ...
            markeredgewidth=LARGE_MARKER_EDGE_WIDTH,
        )
        count += len(points)
    ...
    *,
    ...
    for group_results, metric_key, marker, label_color in combined_groups:
        ...
        _plot_hollow_markers(
            ...
            color=color,
            markersize=ZOOM_LARGE_MARKER_SIZE,
            markeredgewidth=ZOOM_LARGE_MARKER_EDGE_WIDTH,
        )
        count += len(points)
