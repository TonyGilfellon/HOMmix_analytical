...
RTOTAL_TWO_PANEL_LEGEND_FONTSIZE = 7.5
...
def _plot_rtotal_groups_on_axis(
    ...
    *,
    ...
    """Plot retained R_total groups on a supplied axis."""
    count = 0
...
def _write_combined_rtotal_overall_and_zoom_log_plot(
    *,
    ...
    """Write the full logarithmic plot beside its logarithmic zoom."""
    ...
    output_file = (
        output_root
        / "homotypic_and_heterotypic_ell_vs_Rtotal_overall_and_zoom_log.png"
    )
    output_file.parent.mkdir(parents=True, exist_ok=True)
    fig.savefig(
        output_file,
    ...
    print(
        ...
        f"zoom R_total=[{rtotal_min}, {rtotal_max}]"
    )
    return output_file
